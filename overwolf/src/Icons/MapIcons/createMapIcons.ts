...
export async function createMapIcons(scale: number) {
    return {
        ...
        al1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        al2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        al3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        am1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        am2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        am3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        as1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        as2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        as3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'purple', scale }),
        cl1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cl2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cl3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cm1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cm2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cm3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cs1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cs2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        cs3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'green', scale }),
        sl1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        sl2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        sl3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        sm1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        sm2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        sm3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        ss1: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        ss2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        ss3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'orange', scale }),
        oe2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
        oe3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
        oe4: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
        oe5: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
        se2: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
        se3: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
        se4: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
        se5: await svgMapIconToImageBitmap(ChestIcon, { fill: 'yellow', scale }),
