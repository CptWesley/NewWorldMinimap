...
We have included a webpack plugin that can change the .opk version quickly with just a command line argument. Simlpy add ```--env setVersion=1.0.1``` to your build command.
Example:
```
